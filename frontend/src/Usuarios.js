...
export class Usuarios extends Component {
    ...
    changeUserFornecedor =(e)=>{
        this.setState({UserFornecedor:e.target.value});
    }
    changeUserProduto =(e)=>{
        this.setState({UserProduto:e.target.value});
    }
    changeUserFio =(e)=>{
        this.setState({UserFio:e.target.value});
    }
    changeUserCorFio =(e)=>{
        this.setState({UserCorFio:e.target.value});
    }
    changeUserBob =(e)=>{
        this.setState({UserBob:e.target.value});
    }
    changeUserQtdFio =(e)=>{
        this.setState({UserQtdFio:e.target.value});
    }
    changeUserBarra =(e)=>{
        this.setState({UserBarra:e.target.value});
    }
    changeUserMaquina =(e)=>{
        this.setState({UserMaquina:e.target.value});
    }
    changeUserRolos =(e)=>{
        this.setState({UserRolos:e.target.value});
    }
    changeUserMetros =(e)=>{
    ...
    editClick(use) {
        this.setState({
            ...
            UserFornecedor: use.UserFornecedor,
            UserFio: use.UserFio,
            UserCorFio: use.UserCorFio,
            UserBob: use.UserBob,
            UserQtdFio: use.UserQtdFio,
            UserBarra: use.UserBarra,
            UserMaquina: use.UserMaquina,
            UserRolos: use.UserRolos,
            ...
            <th>Data_cadastro </th>
                    ...
                    {users.slice((page - 1) * limit, page * limit).map(use =>
                            <tr key={use.UserId}>
                                ...
                                <td>{use.UserFio}</td> 
                                <td>{use.UserCorFio}</td> 
                                <td>{use.UserBob}</td> 
                                <td>{use.UserQtdFio}</td> 
                                <td>{use.UserBarra}</td> 
                                ...
                                <div className="input-group mb-3">
                                    ...
                                    <div className="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            onChange={this.changeUserProduto}
                                        >
                                            {/* Add the options dynamically from your API or other data source */}
                                    ...
                                    <span className="input-group-text">Fornecedor 
                                    </span>
                                    <input type="text" className="form-control" placeholder={this.state.UserFornecedor}
                                        value={users.UserFornecedor}
                                        onChange={this.changeUserFornecedor}></input>
                                    </div>
                                    <div className="input-group mb-3"></div>
                                    <span className="input-group-text">Fio</span>
                                    <input type="text" className="form-control" placeholder={this.state.UserFio}
                                        value={users.UserFio}
                                        onChange={this.changeUserFio}></input>
                                    ...
                                    <span className="input-group-text">CorFio</span>
                                        <select
                                            ...
                                            onChange={this.changeUserCorFio}
                                            placeholder='Select'
                                        >
                                            {/* Add the options dynamically from your API or other data source */}
                                    ...
                                    <span className="input-group-text">QtdFio 
                                    </span>
                                    <input type="text" className="form-control" placeholder={this.state.UserQtdFio}
                                        value={users.UserQtdFio}
                                        onChange={this.changeUserQtdFio}></input>
                                    ...
                                    <input type="text" className="form-control" placeholder={this.state.UserRolos}
                                        value={users.UserRolos}
                                        onChange={this.changeUserRolos}></input>
